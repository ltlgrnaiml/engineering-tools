# L3 Execution: Grok Code Fast 1

**Branch**: `experiment/l3-grok`
...
```bash
git checkout experiment/l3-grok
```
...
**EXPERIMENT EXP-001: L3 Plan Execution (Grok)**
...
3. Copy results to `results/RESULTS_L3_GROK.json`
