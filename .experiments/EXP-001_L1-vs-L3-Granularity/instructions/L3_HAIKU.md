# L3 Execution: Claude Haiku

**Branch**: `experiment/l3-haiku`
**Model**: Claude Haiku
**Cost**: 1x
...
```bash
git checkout experiment/l3-haiku
```
...
**EXPERIMENT EXP-001: L3 Plan Execution (Haiku)**
...
3. Copy results to `results/RESULTS_L3_HAIKU.json`
