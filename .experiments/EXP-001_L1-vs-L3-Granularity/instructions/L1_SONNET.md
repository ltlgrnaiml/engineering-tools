# L1 Execution: Claude Sonnet 4.5 Thinking

**Branch**: `experiment/l1-sonnet`
...
```bash
git checkout experiment/l1-sonnet
```
...
**EXPERIMENT EXP-001: L1 Plan Execution (Sonnet)**
...
3. Copy results to `results/RESULTS_L1_SONNET.json`
