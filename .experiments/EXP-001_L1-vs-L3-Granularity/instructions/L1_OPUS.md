# L1 Execution: Claude Opus 4.5 Thinking

**Branch**: `experiment/l1-opus`
...
```bash
git checkout experiment/l1-opus
```
...
**EXPERIMENT EXP-001: L1 Plan Execution (Opus)**
...
3. Copy results to `results/RESULTS_L1_OPUS.json`
