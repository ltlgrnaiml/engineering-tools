# L1 Execution: GPT-5.2 High Reasoning Fast

**Branch**: `experiment/l1-gpt52`
...
```bash
git checkout experiment/l1-gpt52
```
...
**EXPERIMENT EXP-001: L1 Plan Execution (GPT-5.2)**
...
3. Copy results to `results/RESULTS_L1_GPT52.json`
